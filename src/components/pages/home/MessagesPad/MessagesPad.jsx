...
const MessagesPad = () => {
  return (
    <div>
      ...
      <div className="h-screen flex pt-20 w-36 justify-end">
         {/* Side Navigator  */}
         <div className="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-white rounded-3xl h-96 shadow-xl">
          ...
          <ul className="flex flex-col space-y-2 mt-12">
            ...
            {/* MESSAGE */}
            <li>
            <a href="/message" className="flex items-center cursor-not-allowed">
        ...
        <div className="flex flex-row w-94 flex-shrink-0 bg-gray-100 p-4">
              ...
              <div className="flex flex-col -mx-4">
                <div className="relative flex flex-row items-center p-4">
                  ...
                  <div className="flex flex-col flex-grow ml-3">
                    <div className="text-sm font-medium">Janam</div>
                ...
                <div className="flex flex-row items-center p-4 bg-gradient-to-r from-red-100 to-transparent border-l-2 border-red-500">
                  ...
                  <div className="flex flex-col flex-grow ml-3">
                    <div className="flex items-center">
                      <div className="text-sm font-medium">Tanvir</div>
            ...
            <div className="h-full overflow-hidden relative pt-2">
              <div className="flex flex-col divide-y h-full overflow-y-auto -mx-4">
                <div className="flex flex-row items-center p-4 relative">
                  ...
                  <div className="flex flex-col flex-grow ml-3">
                    <div className="text-sm font-medium">Mahabub</div>
              ...
              <div className="absolute bottom-0 right-0 mr-2">
                <button className="flex items-center justify-center shadow-sm h-10 w-10 bg-orange-400 text-white rounded-full">
        ...
        <div className="flex flex-col h-full w-full bg-white px-4 py-6">
          <div className="flex flex-row items-center py-4 px-6 rounded-2xl shadow">
            ...
            <div className="flex flex-col ml-3">
              <div className="font-semibold text-sm">Tanvir</div>
            ...
            <div className="h-full overflow-y-auto">
              <div className="grid grid-cols-12 gap-y-2">
                <div className="col-start-1 col-end-8 p-3 rounded-lg">
                  <div className="flex flex-row items-center">
                    <div
                      className="flex items-center justify-center h-10 w-10 rounded-full bg-pink-500 flex-shrink-0"
                    >
                      T
                    </div>
                    <div
